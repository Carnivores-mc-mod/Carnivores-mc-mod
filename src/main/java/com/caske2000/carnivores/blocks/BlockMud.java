...
public class BlockMud extends BlockFluidClassic {
	...
	public BlockMud(Fluid fluid, Material material) {
     ...
     public void registerBlockIcons(IIconRegister register) {
             stillIcon = register.registerIcon(Reference.MODID + ":" + "mud_still");
             flowingIcon = register.registerIcon(Reference.MODID + ":" + "mud_flow");
     }
